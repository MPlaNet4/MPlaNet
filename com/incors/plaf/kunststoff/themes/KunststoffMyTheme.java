 ...
 * @version
 */
public class KunststoffMyTheme extends com.incors.plaf.kunststoff.KunststoffTheme
{
    // primary colors
    ...
    private final ColorUIResource primary3 = new ColorUIResource(0, 255, 0);
	//
private final ColorUIResource primaryHighlight = new ColorUIResource(255,0,255);
private final ColorUIResource controlHighlight = new ColorUIResource(255,255,0);

    // secondary colors
    private final ColorUIResource secondary1 = new ColorUIResource(255, 255, 100);
    private final ColorUIResource secondary2 = new ColorUIResource(255, 255, 155);
    private final ColorUIResource secondary3 = new ColorUIResource(255, 255, 0);
